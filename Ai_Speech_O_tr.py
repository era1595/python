...
def listen():
    ...
    with sr.Microphone() as source:
        ...
        try:
            ...
            print("Ses işleniyor...")
            text = r.recognize_google(audio, language='tr-TR') # Kept as English
...
def speak(text):
    ...
    try:
        ...
        tts = gTTS(text=text, lang='tr', slow=False) # Kept as English
...
if __name__ == '__main__':
    ...
    try:
        while True:
            ...
            if "asistan" in command: # "assistant" kelimesini Türkçe'ye çevirdim, ancak anahtar kelime olarak kalabilir. Kullanıcı "asistan" diyecektir.
                speak("Dinliyorum")
                input_text = listen()
                if input_text:
